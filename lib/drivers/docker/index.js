...
DockerDriver.prototype.start = function(instanceMetas, cb) {
  ...
  function pullNode(next) {
    console.log('Pulling base docker image: node:0.10');
  ...
  function pullDebian(next) {
    console.log('Pulling base docker image: debian:jessie');
  ...
  //     "commit":{"hash":"69a0c1043e4882d48f7d2ae2e68013824e368e61","dir":"/Users/ryan/work/strong-pm/.strong-pm/svc/1/work/69a0c1043e4882d48f7d2ae2e68013824e368e61.1431733664453"},
  //     "size":"CPU"
  //   }
  // }
  function resumeInstances(next) {
    for (var id in instanceMetas) {
      self.resume(id, instanceMetas[id]);
    }
  }
};

DockerDriver.prototype.resume = function(id, meta) {
  var self = this;
  var instance = this._instance(id);
  var image = instance.next = new Image(this, id, this.baseDir);
